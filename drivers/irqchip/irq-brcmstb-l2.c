...
static int brcmstb_l2_2711_lvl_intc_probe(struct platform_device *pdev, struct device_node *parent)
{
	return brcmstb_l2_intc_probe(pdev, parent, &l2_2711_lvl_intc_init);
}
